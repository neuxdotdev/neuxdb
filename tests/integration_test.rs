...
fn test_create_insert_select() -> Result<()> {
    // recover mutex jika poisoned oleh test sebelumnya
    ...
    // Test select with condition (Int vs Text equality check)
    // id disimpan sebagai text "2", query memakai Int 2. loose_eq harusnya match.
